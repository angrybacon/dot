...
See https://fonts.google.com/icons for the glyph code points to use.

#+BEGIN_SRC python
groups_font = 'Material Design Icons'
groups = [
    Group(label='\U0000E5CD', layout='monadtall', name='1', spawn=['brave']),
    Group(label='\U0000E5CD', layout='monadtall', name='2', spawn=['discord']),
    Group(label='\U0000E5CD', layout='monadtall', name='3'),
    Group(label='\U0000E5CD', layout='monadtall', name='4'),
    Group(label='\U0000E5CD', layout='monadtall', name='5'),
    Group(label='\U0000E5CD', layout='monadtall', name='6'),
    Group(label='\U0000E5CD', layout='monadtall', name='7'),
    Group(label='\U0000E5CD', layout='monadtall', name='8'),
    Group(label='\U0000E5CD', layout='monadtall', name='9', spawn=['spotify']),
    Group(label='\U0000E5CD', layout='monadwide', name='0'),
]
