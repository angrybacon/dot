...
groups_web = [Match(wm_class='brave'), Match(wm_class='firefox')]
groups_game = [Match(wm_class='lutris'), Match(wm_class='Steam')]
groups_social = [Match(wm_class='discord'), Match(wm_class='slack')]

groups = [
    Group('1', label='\U0000EF4A', matches=groups_web, spawn=['brave']),
