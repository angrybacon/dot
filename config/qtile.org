...
def widgets_list():
    ...
    return [
        ...
        widget.Spacer(length=16),
        widget.KeyboardLayout(**text, configured_keyboards=['us', 'us intl']),
        widget.Spacer(length=16),
...
screens_bar = bar.Bar(background='#494949.25', size=48, widgets=widgets_list())
