...
color_box_background= '#5C888B.80'
color_box_background_transient= '#9C6363.80'
color_box_foreground = '#FFFFEF'
color_chart_background = '#7F9F7F.60'
color_chart_border = '#7F9F7F.60'
color_chart_foreground = '#7F9F7F'
color_foreground = '#DCDCCC'
color_group_active = '#DCDCCC'
color_group_current = '#93E0E3'
