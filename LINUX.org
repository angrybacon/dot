...
paru -S \
    ...
    cockatrice spotify \                # Entertainment: applications
    obs-studio vlc \                    # Entertainment: utilities
    flameshot gimp \                    # Image
    qbittorrent \                       # Torrents
    btop gtop htop \                    # System: monitors
    piper \                             # System: peripherals
    gdu most tree \                     # System: utilities
    brave-bin chromium librewolf-bin    # Web
#+END_SRC
