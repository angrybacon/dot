...
#+BEGIN_SRC sh
yay -S \
    cmake git highlight openssh vi vim xclip
#+END_SRC
...
#+BEGIN_SRC sh
yay -S \
    btop deluge-gtk duf feh flameshot flameshot gimp htop kitty ncdu nemo \
    neofetch obs-studio piper playerctl ripgrep spotify tagger tree
#+END_SRC
...
Increase the default keyboard repeat rate.
